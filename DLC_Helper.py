...
# -*- coding: utf-8 -*-
"""
Created on July 19th 2019 15:03
@author: Chase Dudas, alex
DEVELOPERS:
...
task= input("What is the project title?\n") # Enter the name of your experiment Task
scorer= input("Who is the experimenter?\n") # Enter the name of the experimenter/labeler
